...
에브리런 회원들과 대화를 나눠보세요~
			...
			<div id="wrap-comm">
				<div id="orderby">
					...
					<div class="container mt-3"  style="width: 800px; margin: auto;">
						<table class="table table-hover" style="text-align: center; height: 300px;" >
							<thead>
							...
							<tr style="height: 50px !important;">
								<td style="margin-top: 6px;">${status.count}</td>
								<td style="margin-top: 6px;">
								<a id="title" href="/el/class/detail?classCommNo=${free.classCommNo}&lc=${loginMember.memberNo}">${free.title}</a>
								</td>
								<td style="margin-top: 6px;">${free.hit }</td>
							</tr>
							</c:forEach>
							</tbody>
						</table>
