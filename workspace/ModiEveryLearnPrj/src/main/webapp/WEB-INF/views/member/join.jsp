...
<body>
    ...
    <div id="contain">
        <!-- <div id="top-join"> -->
            ...
            <div id="wrap-join">
                ...
                <form action="/el/member/join" method="post" id="join-form" onsubmit="return jin();">
    ...
    - 8자~20자(공백 제외)</pre>
                ...
                <span class="join-box">
                    <input type="text" id="memberName"  name="memberName" onblur="emptyName()">
                </span>   
                <div class="warning" id="Namech"></div>
                <h4><label for="">* 휴대폰 번호</label></h4>
                <span class="join-box" >
                    <!-- <input type="tel" name="phone" placeholder="숫자만 입력해주세요."> -->
                    <input type="text" name="phone" id="phone" onblur="emptyPhone()" placeholder=" '-' 없이 숫자만 입력해주세요" onkeyup="chk_tel(this.value,'test_id')"">
                </span> 
                <div class="warning" id="phoneCheck"></div>  
                </span>   
                ...
                <span class="join-box">
                    ...
                    <button type="button" id="nick-double-check" onblur="emptyNick()" onclick="nickDup()">중복확인</button>
                </span>   
