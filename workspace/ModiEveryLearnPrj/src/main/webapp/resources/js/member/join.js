		...
		$.ajax({
			...
			success : function(result){
                if(result == '1' ) {
					...
					$("#idDup").html("*필수 입력사항입니다. ").css("color", "red");
                    $('#memberId').val('');
                    return false;
				}		
                else {
...
function checkPw() {
    ...
    // } 
        ...
        $('#pwdch').html("*비밀번호가 정상적으로 입력되었습니다.").css("color", "green");
        return true;
    }
...
//닉네임 비어있는지 여부
function emptyNick() {
    let emptyId = $('#memberNick').val();

    if(emptyId == ''){
        $("#nickDup").html("*필수입력사항입니다.").css("color", "red");
        return false;
    }else{
        return true;
    }
...
function emailCh(){
    ...
    var exptext = /^[A-Za-z0-9_\.\-]+@[A-Za-z0-9\-]+\.[A-Za-z0-9\-]+/;
        ...
        $("#emailCheck").html("*필수입력사항입니다.").css("color", "red");
        return false;
    }
...
function emptyPhone() {
    ...
    if(phone == ''){
        $("#phoneCheck").html("*필수입력사항입니다.").css("color", "red");
        return false;
    }else{
        return true;
    }
